...
public class ArrangementLop extends Arrangement{
    ...
    public ArrangementLop(int arrangementId, String navn, String type, int antallPlasser, LocalDateTime startDato, LocalDateTime sluttDato,
                          String plassering, String vanskelighetsgrad) {
        super(arrangementId, navn, type, antallPlasser, startDato, sluttDato, plassering);
